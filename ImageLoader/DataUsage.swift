...
//  ImageLoader
//
//  Created by Ramunas Jurgilas on 2018-04-10.
...
struct DataUsageInfo {
    ...
    static func -(lhs: DataUsageInfo, rhs: DataUsageInfo) -> DataUsageInfo {
        let wifiSent = lhs.wifiSent - rhs.wifiSent
        let wifiReceived = lhs.wifiReceived - rhs.wifiReceived
        let wirelessWanDataReceived = lhs.wirelessWanDataReceived - rhs.wirelessWanDataReceived
        let wirelessWanDataSent = lhs.wirelessWanDataSent - rhs.wirelessWanDataSent
        return DataUsageInfo(wifiReceived: wifiReceived, wifiSent: wifiSent, wirelessWanDataReceived: wirelessWanDataReceived, wirelessWanDataSent: wirelessWanDataSent)
    }
